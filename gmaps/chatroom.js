...
function initMap() {
    map = new google.maps.Map(document.getElementById("map"), {
        center: { lat: 24.136813, lng: 120.68523 },
        // center: pos,
        zoom: 14,
    });
    ...
    const icons = [
        {
            url:
                "https://cdn.bulbagarden.net/upload/thumb/2/21/001Bulbasaur.png/600px-001Bulbasaur.png",
            scaledSize: new google.maps.Size(75, 75),
        },
        {
            url:
                "https://cdn.bulbagarden.net/upload/thumb/7/73/004Charmander.png/600px-004Charmander.png",
            scaledSize: new google.maps.Size(75, 75),
        },
        {
            url:
        ...
        {
            url:
                "https://i.pinimg.com/originals/c5/67/9d/c5679d385fe4f711dcae098c70d59aa4.jpg",
            scaledSize: new google.maps.Size(75, 75),
        },
    ];
